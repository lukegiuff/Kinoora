              ...
              <div>
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-gray-900 mb-2">Early Supporter Badge</h3>
                      <p className="text-gray-700">Special profile recognition as an early supporter of independent cinema.</p>
                    </div>
                  </div>
                </div>
              </div>
